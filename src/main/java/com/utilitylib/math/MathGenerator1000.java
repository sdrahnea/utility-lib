...
@Slf4j
public class MathGenerator1000 {

    private static final String DEFAULT_PATH = "src/main/resources/pdf/num_lt_1000_sum/";
    private static final String LEFT_ZEROS = "%05d";
    ...
    public static void generate(final String fileName) {
        try {
            ...
            for (int index = 0; index < 25; index++) {
                ...
                TextDTO textDTO1 = new TextDTO(generateTwoPositionNumbers(999), 100, ty, 12);
                TextDTO textDTO2 = new TextDTO(generateTwoPositionNumbers(999), 275, ty, 12);
                TextDTO textDTO3 = new TextDTO(generateTwoPositionNumbers(999), 450, ty, 12);
                textDTO1.setTy(ty);
                textDTO2.setTy(ty);
                textDTO3.setTy(ty);
